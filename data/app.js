...
function append_files_to_fallback_list(path, files) {
    ...
    html += `<img src="${item.thumbnailLink || 'default_video.png'}" class="file-thumb" style="max-height:40px; margin-right:6px;">`
    ...
    html += `<img src="${item.thumbnailLink || 'default_image.png'}" class="file-thumb" style="max-height:40px; margin-right:6px;">`
